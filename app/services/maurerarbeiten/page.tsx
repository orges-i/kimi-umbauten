...
export const metadata: Metadata = {
  title: "Maurerarbeiten | KIMI Umbauten",
  description: "Präzise Maurerarbeiten für Neu- und Umbauten. Professionelle Bauarbeiten in der ganzen Schweiz.",
}
    ...
    <div className="flex flex-col">
      <section className="bg-gradient-to-br from-secondary via-secondary/95 to-secondary/90 px-4 py-20 text-secondary-foreground">
        <div className="mx-auto max-w-4xl text-center">
          <h1 className="text-balance text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">Maurerarbeiten</h1>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="grid gap-8 lg:grid-cols-[250px_1fr]">
          ...
          <div className="space-y-8">
            <section>
              <h2 className="mb-4 text-3xl font-bold">Maurerarbeiten</h2>
              <p className="text-pretty text-lg text-muted-foreground leading-relaxed">
                Präzise Maurerarbeiten für Neu- und Umbauten. Von Fundamenten bis zu Mauerwerken – wir bieten solide
                Handwerkskunst und jahrelange Erfahrung. Unsere Maurerarbeiten bilden das stabile Fundament für Ihr
                Bauprojekt.
              </p>
            </section>

            <section className="rounded-lg bg-secondary p-8 text-center text-secondary-foreground">
              <h2 className="mb-4 text-2xl font-bold">Interessiert an Maurerarbeiten?</h2>
