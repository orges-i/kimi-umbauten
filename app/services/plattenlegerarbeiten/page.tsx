...
export const metadata: Metadata = {
  title: "Plattenlegerarbeiten | KIMI Umbauten",
  description:
    "Fachgerechte Fliesenverlegung in höchster Qualität. Professionelle Plattenlegerarbeiten in der ganzen Schweiz.",
}

export default function PlattenlegerarbeitenPage() {
  const services = [
      ...
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="grid gap-8 lg:grid-cols-[250px_1fr]">
          ...
          <div className="space-y-8">
            <section>
              <h2 className="mb-4 text-3xl font-bold">Plattenlegerarbeiten</h2>
              <p className="text-pretty text-lg text-muted-foreground leading-relaxed">
                Fachgerechte Fliesenverlegung in höchster Qualität. Für Bäder, Küchen und alle Wohnbereiche. Wir
                verlegen Fliesen präzise und sauber – von klassischen Keramikfliesen bis zu modernen Großformaten.
              </p>
            </section>

            <section className="rounded-lg bg-secondary p-8 text-center text-secondary-foreground">
              <h2 className="mb-4 text-2xl font-bold">Interessiert an Plattenlegerarbeiten?</h2>
