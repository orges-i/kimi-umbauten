...
export const metadata: Metadata = {
  title: "Malerarbeiten | KIMI Umbauten",
  description: "Saubere, langlebige und kreative Malerarbeiten. Professionelle Malerarbeiten in der ganzen Schweiz.",
}
    ...
    <div className="flex flex-col">
      <section className="bg-gradient-to-br from-secondary via-secondary/95 to-secondary/90 px-4 py-20 text-secondary-foreground">
        <div className="mx-auto max-w-4xl text-center">
          <h1 className="text-balance text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">Malerarbeiten</h1>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="grid gap-8 lg:grid-cols-[250px_1fr]">
          ...
          <div className="space-y-8">
            <section>
              <h2 className="mb-4 text-3xl font-bold">Malerarbeiten</h2>
              <p className="text-pretty text-lg text-muted-foreground leading-relaxed">
                Saubere, langlebige und kreative Malerarbeiten. Innen- und Außenanstriche in allen Farben und Techniken.
                Wir verleihen Ihren Räumen und Fassaden einen frischen, modernen Look mit hochwertigen Farben und
                professioneller Ausführung.
              </p>
            </section>

            <section className="rounded-lg bg-secondary p-8 text-center text-secondary-foreground">
              <h2 className="mb-4 text-2xl font-bold">Interessiert an Malerarbeiten?</h2>
